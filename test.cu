...
void cu_euclid_test(void){
    ...
    cu_BN_dec2bn(&A[0], "37395592152339737887907045642814123062971460511339303756999809410306458561931007874617067005011081081434");
    cu_BN_dec2bn(&B[0], "6488844988435715869579769013263596622885949764567161657286287302178494741471316643019047812596");

    A = cu_euclid(&A[0], &B[0]);
	assert(!strcmp("11955076BA002A35C912FC9BBF739E6B15FFC540A61A", cu_bn_bn2hex(A)));
